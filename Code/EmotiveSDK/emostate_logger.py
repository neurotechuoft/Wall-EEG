...
def logEmoState(userID, eState):
    f.write(IS_GetTimeFromStart(eState) + " ,")
    f.write(userID.value + ",")
    f.write(IS_GetWirelessSignalStatus(eState) + ",")
    f.write(IS_FacialExpressionIsBlink(eState) + ",")
    f.write(IS_FacialExpressionIsLeftWink(eState) + ",")
    f.write(IS_FacialExpressionIsRightWink(eState) + ",")
    ...
    f.write(FacialExpressionStates[FE_SUPPRISE] + ",")
    f.write(FacialExpressionStates[FE_FROWN] + ",")
    f.write(FacialExpressionStates[FE_SMILE] + ",")
    f.write(FacialExpressionStates[FE_CLENCH] + ",")

    IS_FacialExpressionGetEyeLocation(eState,X,Y)
    f.write(EyeX.value + ",")
    f.write(EyeY.value + ",")
    IS_FacialExpressionGetEyeLocation(eState,Left,Right)
    f.write(EyeLidLeft.value + ",")
    f.write(EyeLidRight.value + ",")

    # Performance metrics Suite results
    f.write(IS_PerformanceMetricGetExcitementLongTermScore(eState) + ",")
    f.write(IS_PerformanceMetricGetInstantaneousExcitementScore(eState) + ",")    
    #IS_PerformanceMetricGetInstantaneousExcitementModelParams(eState, Raw, Min, Max)
    f.write(RawScore.value + ",")
    f.write(MinScale.value + ",")
    f.write(MaxScale.value + ",")
    f.write(IS_PerformanceMetricGetStressScore(eState) + ",")
    IS_PerformanceMetricGetStressModelParams(eState, Raw, Min, Max)
    f.write(RawScore.value + ",")
    f.write(MinScale.value + ",")
    f.write(MaxScale.value + ",")
    f.write(IS_PerformanceMetricGetRelaxationScore(eState) + ",")
    IS_PerformanceMetricGetRelaxationModelParams(eState, Raw, Min, Max)
    f.write(RawScore.value + ",")
    f.write(MinScale.value + ",")
    f.write(MaxScale.value + ",")
    f.write(IS_PerformanceMetricGetEngagementBoredomScore(eState) + ",")
    IS_PerformanceMetricGetEngagementBoredomModelParams(eState, Raw, Min, Max)
    f.write(RawScore.value + ",")
    f.write(MinScale.value + ",")
    f.write(MaxScale.value + ",")
    f.write(IS_PerformanceMetricGetInterestScore(eState) + ",")
    IS_PerformanceMetricGetInterestModelParams(eState, Raw, Min, Max)
    f.write(RawScore.value + ",")
    f.write(MinScale.value + ",")
    f.write(MaxScale.value + ",")
    f.write(IS_PerformanceMetricGetFocusScore(eState) + ",")
...
#Write header to beginning of ES.csv
#print f, header
